...
**Agents / Prompts / Workflows / Knowledge:** `AGENT_PUBLISHED`, `AGENT_DEPRECATED`, `PROMPT_PUBLISHED`, `PROMPT_ROLLED_BACK`, `WORKFLOW_PUBLISHED`, `KNOWLEDGE_BASE_CREATED`, `KNOWLEDGE_BASE_DELETED`, `DOCUMENT_DELETED`
...
| Configuration, campaign, plugin lifecycle changes | Asynchronous (Celery) |
