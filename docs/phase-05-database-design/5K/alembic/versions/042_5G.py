"""Phase 5K — wraps frozen migration 042_5G.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/042_5G.sql verbatim via
...
revision: str = '042_5G'
down_revision: Union[str, None] = '041_5G'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 042_5G is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/042_5G.sql). No rollback DDL exists for "
