"""Phase 5K — wraps frozen migration 059_5I.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/059_5I.sql verbatim via
...
revision: str = '059_5I'
down_revision: Union[str, None] = '058_5H'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 059_5I is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/059_5I.sql). No rollback DDL exists for "
