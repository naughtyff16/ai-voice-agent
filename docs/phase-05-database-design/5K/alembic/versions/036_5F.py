"""Phase 5K — wraps frozen migration 036_5F.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/036_5F.sql verbatim via
...
revision: str = '036_5F'
down_revision: Union[str, None] = '035_5F'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 036_5F is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/036_5F.sql). No rollback DDL exists for "
