"""Phase 5K — wraps frozen migration 072_5J.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/072_5J.sql verbatim via
...
revision: str = '072_5J'
down_revision: Union[str, None] = '071_5J'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 072_5J is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/072_5J.sql). No rollback DDL exists for "
