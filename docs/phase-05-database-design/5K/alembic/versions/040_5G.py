"""Phase 5K — wraps frozen migration 040_5G.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/040_5G.sql verbatim via
...
revision: str = '040_5G'
down_revision: Union[str, None] = '039_5G'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 040_5G is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/040_5G.sql). No rollback DDL exists for "
