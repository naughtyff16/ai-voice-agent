"""Phase 5K — wraps frozen migration 019_5D.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/019_5D.sql verbatim via
...
revision: str = '019_5D'
down_revision: Union[str, None] = '018_5C'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 019_5D is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/019_5D.sql). No rollback DDL exists for "
