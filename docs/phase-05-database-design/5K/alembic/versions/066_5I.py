"""Phase 5K — wraps frozen migration 066_5I.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/066_5I.sql verbatim via
...
revision: str = '066_5I'
down_revision: Union[str, None] = '065_5I'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 066_5I is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/066_5I.sql). No rollback DDL exists for "
