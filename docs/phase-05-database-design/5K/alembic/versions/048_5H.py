"""Phase 5K — wraps frozen migration 048_5H.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/048_5H.sql verbatim via
...
revision: str = '048_5H'
down_revision: Union[str, None] = '047_5H'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 048_5H is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/048_5H.sql). No rollback DDL exists for "
