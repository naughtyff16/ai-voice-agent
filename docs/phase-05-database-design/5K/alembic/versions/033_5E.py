"""Phase 5K — wraps frozen migration 033_5E.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/033_5E.sql verbatim via
...
revision: str = '033_5E'
down_revision: Union[str, None] = '032_5E'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 033_5E is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/033_5E.sql). No rollback DDL exists for "
