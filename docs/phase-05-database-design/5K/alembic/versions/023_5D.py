"""Phase 5K — wraps frozen migration 023_5D.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/023_5D.sql verbatim via
...
revision: str = '023_5D'
down_revision: Union[str, None] = '022_5D'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 023_5D is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/023_5D.sql). No rollback DDL exists for "
