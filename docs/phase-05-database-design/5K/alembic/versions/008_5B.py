"""Phase 5K — wraps frozen migration 008_5B.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/008_5B.sql verbatim via
...
revision: str = '008_5B'
down_revision: Union[str, None] = '007_5B'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 008_5B is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/008_5B.sql). No rollback DDL exists for "
