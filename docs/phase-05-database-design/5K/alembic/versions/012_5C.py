"""Phase 5K — wraps frozen migration 012_5C.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/012_5C.sql verbatim via
...
revision: str = '012_5C'
down_revision: Union[str, None] = '011_5C'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 012_5C is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/012_5C.sql). No rollback DDL exists for "
