"""Phase 5K — wraps frozen migration 010_5C.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/010_5C.sql verbatim via
...
revision: str = '010_5C'
down_revision: Union[str, None] = '009_5C'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 010_5C is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/010_5C.sql). No rollback DDL exists for "
