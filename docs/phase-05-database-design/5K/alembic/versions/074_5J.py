"""Phase 5K — wraps frozen migration 074_5J.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/074_5J.sql verbatim via
...
revision: str = '074_5J'
down_revision: Union[str, None] = '073_5J'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 074_5J is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/074_5J.sql). No rollback DDL exists for "
