"""Phase 5K — wraps frozen migration 070_5J.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/070_5J.sql verbatim via
...
revision: str = '070_5J'
down_revision: Union[str, None] = '069_5J'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 070_5J is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/070_5J.sql). No rollback DDL exists for "
