"""Phase 5K — wraps frozen migration 007_5B.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/007_5B.sql verbatim via
...
revision: str = '007_5B'
down_revision: Union[str, None] = '006_5B'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 007_5B is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/007_5B.sql). No rollback DDL exists for "
