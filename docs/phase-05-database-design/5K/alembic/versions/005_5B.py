"""Phase 5K — wraps frozen migration 005_5B.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/005_5B.sql verbatim via
...
revision: str = '005_5B'
down_revision: Union[str, None] = '004_5B'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 005_5B is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/005_5B.sql). No rollback DDL exists for "
