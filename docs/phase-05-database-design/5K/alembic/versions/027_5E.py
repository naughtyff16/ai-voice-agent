"""Phase 5K — wraps frozen migration 027_5E.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/027_5E.sql verbatim via
...
revision: str = '027_5E'
down_revision: Union[str, None] = '026_5D'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 027_5E is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/027_5E.sql). No rollback DDL exists for "
