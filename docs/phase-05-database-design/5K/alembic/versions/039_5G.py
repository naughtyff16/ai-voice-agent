"""Phase 5K — wraps frozen migration 039_5G.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/039_5G.sql verbatim via
...
revision: str = '039_5G'
down_revision: Union[str, None] = '038_5F'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 039_5G is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/039_5G.sql). No rollback DDL exists for "
