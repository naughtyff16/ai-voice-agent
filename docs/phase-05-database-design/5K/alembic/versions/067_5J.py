"""Phase 5K — wraps frozen migration 067_5J.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/067_5J.sql verbatim via
...
revision: str = '067_5J'
down_revision: Union[str, None] = '066_5I'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 067_5J is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/067_5J.sql). No rollback DDL exists for "
