"""Phase 5K — wraps frozen migration 022_5D.sql.

This revision does not define schema itself. It executes the frozen,
canonical SQL file 5K/migrations/022_5D.sql verbatim via
...
revision: str = '022_5D'
down_revision: Union[str, None] = '021_5D'
...
def downgrade() -> None:
    raise NotImplementedError(
        "Migration 022_5D is part of the frozen, forward-only 5K SQL "
        "package (5K/migrations/022_5D.sql). No rollback DDL exists for "
